...
// 🌟 لێرەدا ئایکۆنەکان گۆڕدران بۆ وێنە ڕاستەقینەکانی خۆت بە ڕێک و پێکی 🌟
...
export default function Home({ user, settings, theme }: Props) {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#f8fafc] flex flex-col overflow-y-auto overflow-x-hidden relative selection:bg-orange-200 scrollbar-hide font-kosrat" dir="rtl" style={{ WebkitOverflowScrolling: 'touch' }}>
      ...
      {/* ئایکۆنەکانی خوارەوە */}
      <footer className="w-full pb-8 pt-16 flex flex-row flex-wrap items-center justify-center gap-4 sm:gap-6 z-10 relative mt-auto px-4" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom) + 2rem)' }}>
        
        {/* Play Store */}
        <a href="https://play.google.com/store/apps/dev?id=6744749568381312149" target="_blank" rel="noopener noreferrer" className="w-14 h-14 sm:w-16 sm:h-16 rounded-[1.25rem] bg-white border border-neutral-200 shadow-md hover:-translate-y-1.5 hover:shadow-xl hover:border-emerald-200 transition-all flex items-center justify-center p-2.5 sm:p-3 group" title="پلەی ستۆر">
            <img src="/social/playstore.png" alt="Play Store" className="w-full h-full object-contain group-hover:scale-110 transition-transform" loading="lazy" decoding="async" />
        </a>
        
        {/* Telegram */}
        <a href="http://t.me/kosratdev" target="_blank" rel="noopener noreferrer" className="w-14 h-14 sm:w-16 sm:h-16 rounded-[1.25rem] bg-white border border-neutral-200 shadow-md hover:-translate-y-1.5 hover:shadow-xl hover:border-blue-200 transition-all flex items-center justify-center p-2.5 sm:p-3 group" title="تێلیگرام">
            <img src="/social/telegram.png" alt="Telegram" className="w-full h-full object-contain group-hover:scale-110 transition-transform" loading="lazy" decoding="async" />
        </a>

        {/* Darmanzany */}
        <a href="https://play.google.com/store/apps/details?id=com.nmadev.darmanzany&hl=en" target="_blank" rel="noopener noreferrer" className="w-14 h-14 sm:w-16 sm:h-16 rounded-[1.25rem] bg-white border border-neutral-200 shadow-md hover:-translate-y-1.5 hover:shadow-xl hover:border-red-200 transition-all flex items-center justify-center p-2.5 sm:p-3 group" title="دەرمانزانی">
            <img src="/social/darman.png" alt="Darmanzany" className="w-full h-full object-contain group-hover:scale-110 transition-transform" loading="lazy" decoding="async" />
        </a>

        {/* Kosrat Drug */}
        <a href="https://play.google.com/store/apps/details?id=com.NmaDev.Kdrugs&hl=en" target="_blank" rel="noopener noreferrer" className="w-14 h-14 sm:w-16 sm:h-16 rounded-[1.25rem] bg-white border border-neutral-200 shadow-md hover:-translate-y-1.5 hover:shadow-xl hover:border-blue-300 transition-all flex items-center justify-center p-2.5 sm:p-3 group" title="Kosrat Drugs">
            <img src="/social/kosratdrug.png" alt="Kdrugs" className="w-full h-full object-contain group-hover:scale-110 transition-transform" loading="lazy" decoding="async" />
        </a>
